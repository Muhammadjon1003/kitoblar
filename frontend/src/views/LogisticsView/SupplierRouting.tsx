...
/** 1-Kompnent: To'langan buyurtmalarni Telegram ta'minotchiga yuborish */
export function SupplierOrderRoutingSection() {
  const {
    orders,
    groups,
    getStudentName,
...
/** 2-Kompnent: Yo'lda bo'lgan kitob partiyalari va ularni qabul qilish */
export function YoldaPartiyalarSection() {
  const {
    orders,
    groups,
    getStudentName,
  ...
  return (
    <div className="space-y-4">
      ...
      {yoldaBuyurtmalar.length === 0 ? (
        ...
        yoldaBatches.map(([batchTime, batchOrders], batchIdx) => {
...
/** Asosiy SupplierRouting sahifasi (Logistika va Admin uchun ikkala komponentni o'z ichiga oladi) */
export default function SupplierRouting() {
  const { orders, getStudentName, getGroupName, getInventoryItem, groups } = useApp();
